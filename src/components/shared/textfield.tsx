...
export const Textfield = ({
  ...
  const textfieldClasses = useMemo(() => {
    const base = `block w-full bg-white border border-black text-black rounded-md py-2 px-3 text-xs focus:outline-none focus:ring-0.5 focus:ring-green-700 focus:border-green-700`;
