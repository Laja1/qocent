      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute  inset-0 h-full w-full bg-neutral-200  block  rounded-md"
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-md h-full w-full  p-4 overflow-hidden bg-white border border-gray-50   group-hover:border-slate-300    relative z-20",
        className
      )}
    >
