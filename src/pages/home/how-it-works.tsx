...
const HowItWorksCard = ({ icon, title, description, subTitle }: CardProps) => (
  ...
  >
    <div className="space-y-5 py-5 px-4 flex flex-col items-center justify-center">
      ...
      <p className="text-sm text-[#FFFFFF99] leading-relaxed text-center">
        {description}
      </p>
...
export const HowItWorks = () => {
  return (
    <div
      id="solutions"
      className="px-5 py-20 flex flex-col items-center justify-center"
    >
      <div className="text-center max-w-3xl flex flex-col gap-5 px-5">
        ...
        <p className="md:text-base text-sm lg:text-lg leading-[28px] text-gray-700">
          QCS makes code generation as easy as having a conversation. Just
