    ...
    <div className="lg:py-20 flex flex-col items-center w-full mx-auto px-8 py-10">
      ...
      <div className="max-w-6xl flex flex-col lg:flex-row items-center justify-center gap-10 mt-10">
        {[
          ...
          <div
            key={i}
            className="text-center border border-gray-200 bg-white rounded-md hover:shadow-lg transition-shadow duration-300 w-[300px] p-8 flex flex-col justify-center items-center gap-3"
          >
