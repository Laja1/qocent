  ...
  return (
    <div>
      <div className="lg:px-20 w-full mx-auto pt-10 flex">
        <div className="bg-[#1A1A1A] items-center flex flex-col space-y-5 text-center w-full rounded-xl p-10 lg:p-20">
          <p className="bg-gradient-to-r text-xl lg:text-3xl font-poppins from-[#C36659] inline-block text-transparent to-[#750505] bg-clip-text">
