...
export default function ElevateMessage() {
    return (
        <section className="p-12 py-28 px-6 md:p-32 md:px-28 bg-black md:h-screen 2xl:h-2/3">
            <div className="rounded-md max-w-[90rem] mx-auto bg-[#E3D1D1] space-y-8 md:space-y-0 md:h-full grid place-items-center p-4">
                <HeroHeader hideLine={true} description="Unlock your financial potential with Qocent. We provide personalized tools and insights to elevate your financial journey" badgeText="FINANCE ELEVATION" >
                    <h2 className="self-center lg:max-w-1/2 font-bold my-6 text-center text-lg md:text-5xl">
